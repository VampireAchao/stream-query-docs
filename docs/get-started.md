...
```gradle
// https://search.maven.org/artifact/io.github.vampireachao/stream-query
implementation group: 'io.github.vampireachao', name: 'stream-plugin-mybatis-plus', version: '1.0.8'
```
...
```gradle
// https://search.maven.org/artifact/io.github.vampireachao/stream-query
implementation group: 'io.github.vampireachao', name: 'stream-core', version: '1.0.8'
```
